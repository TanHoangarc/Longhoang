...
export function renderTextWithTooltips(text: string) {
  ...
  // Build a regex to match any of the glossary terms
  ...
  return parts.map((part, index) => {
    ...
    if (termData) {
      return (
        <span key={index} className="relative group inline-block font-semibold text-[#0048ba] cursor-help border-b border-dashed border-[#0048ba]/40 hover:border-[#0048ba] transition-colors">
          {part}
